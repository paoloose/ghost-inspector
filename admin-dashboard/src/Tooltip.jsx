...
export default function Tooltip({ content, children, position = 'top' }) {
  ...
  return (
    ...
    >
      {children}
      {visible && (
        <div className={`absolute z-50 ${positions[position]} w-64 px-4 py-2.5.5 bg-bg-card border border-line rounded-md2 shadow-card`}>
          <p className="text-[14px] leading-relaxed text-ink-2">{content}</p>
